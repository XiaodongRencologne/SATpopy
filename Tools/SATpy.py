...
class SAT_v1():
    ...
    def _create_coord(self, Rx_position = [0,0,0]):
        ...
        self.coor_cut = coor_sys([0,0,0],[Ax,Ay,0],ref_coor = self.coor_boresight_ref,name='coor_boresight_ref')
    ...
    def _create_commands(self):
        ...
        get_lens3_cur = get_current(self.PO_lens3,[self.Feed_Gaussian],
                                    accuracy= -80,
