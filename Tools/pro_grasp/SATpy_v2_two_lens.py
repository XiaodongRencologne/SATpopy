...
class SAT_v2():
    def __init__(self, 
        ...
        self.horn_beam_file = Horn_beam_file
        self.freq = freq
    ...
    def _create_coord(self):
        ...
        self.coor_grd = coor_sys([0,0,0],[0,0,0],ref_coor = self.coor_boresight_ref,name='coor_grd')
        
        Ax = -self.Rx_position[0]/self.eff_focal_length
        Ay = self.Rx_position[1]/self.eff_focal_length
    ...
    def _create_lens(self):
        ...
        self.lens1 = simple_lens(self.coor_lens1, lens_diameter1, 
                                ...
                                surf_f1 = '"'+self.srf_folder+'lens1_f1.rsf"',
                                surf_f2 = '"'+self.srf_folder+'lens1_f2.rsf"',
                                lengthUnit = 'cm',
                                name='lens1')
        ...
        self.lens2 = simple_lens(self.coor_lens2, lens_diameter2, 
                                ...
                                surf_f1 = '"'+self.srf_folder+'lens2_f1.rsf"',
        ...
        self.lens3 = simple_lens(self.coor_lens3, lens_diameter3, 
                                ...
                                surf_f1 = '"'+self.srf_folder+'lens3_f1.rsf"',
                                surf_f2 = '"'+self.srf_folder+'lens3_f2.rsf"',
                                lengthUnit = 'cm',
                                name='lens3')        
    ...
    def _create_input(self):
        ...
        for item in freq_list:
            self.freq_list[str(item)] = frequencyList([item], name ='freq_'+str(item))
            self.feedhorn_list[str(item)] = Tabulated_pattern(self.freq_list[str(item)],
                                                              self.coor_feed,
                                                              self.horn_list[str(item)][0],
                                                              self.horn_list[str(item)][1],
                                                              name = 'Feed_'+str(item))
        '''
    ...
    def _create_output(self):
        self.Beam_grid = Spherical_grid(self.coor_grd,
                                        ...
                                        polarisation = 'linear',
                                        near_far='far',
                                        filename='Beam_grid_Rx_x'+str(self.Rx_position[1])+'y'+str(self.Rx_position[1])+'_'+str(self.freq)+'GHz.grd',
                                        name='Beam_grid_Rx_x'+str(self.Rx_position[1])+'y'+str(self.Rx_position[1])+'_'+str(self.freq))
